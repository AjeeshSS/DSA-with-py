...
print()
my_graph.dfs('A')
"""DFS is useful in detecting cycles in a graph and in exploring all possible paths in a graph. In this algorithm, 
we start at the source vertex and explore as far as possible along each branch before backtracking. DFS is useful in 
topological sorting, finding strongly connected components, and solving problems related to trees. """
